...
@section('content')
                                ...
                                @forelse ($returns as $return)
                                    <tr>
                                        ...
                                        <th scope="col">
                                            ...
                                            <span
                                                class="text-info">{{ ucwords($return->status) }}</span>
    ...
    <!--Delete Modal -->
    <div class="modal fade" id="deleteReturnModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
...
@push('js')
    <script>
        $('#deleteReturnModal').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget);
            $('#deleteReturnForm').attr('action', 'admin/return-request/' + button.data('return-id'));
        });
    </script>
@endpush
