        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    @endif
                    <form role="form" method="POST" action="{{ route('stores.store') }}" class="mx-3">
                        @csrf
                                ...
                                <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}"
                                            placeholder="{{ __('Address') }}" type="text" name="address"
                                ...
                                <div class="form-group{{ $errors->has('website') ? ' has-danger' : '' }}">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control{{ $errors->has('website') ? ' is-invalid' : '' }}"
                                            placeholder="{{ __('Website') }}" type="text" name="website"
